...
async function handler(req) {
    ...
    try {
        const addedPro = await ProfessionalsDAL.addProfessional({ body: { lastname: cleanLastname, firstname: cleanFirstname, address: cleanAddress, zip: cleanZip, city: cleanCity, phone: cleanPhone, details: cleanDetails, speciality_id } })
