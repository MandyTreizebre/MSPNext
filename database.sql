...
--
-- Hôte : localhost
-- Généré le : ven. 12 juil. 2024 à 12:53
...
--
-- Structure de la table `category_informations`
--
...
--
-- Tronquer la table avant d'insérer `category_informations`
--

TRUNCATE TABLE `category_informations`;
--
-- Déchargement des données de la table `category_informations`
--
...
--
-- Tronquer la table avant d'insérer `days`
--
...
--
-- Structure de la table `external_professionals`
--
...
CREATE TABLE IF NOT EXISTS `external_professionals` (
  ...
  `link` varchar(60) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Tronquer la table avant d'insérer `external_professionals`
--

TRUNCATE TABLE `external_professionals`;
--
-- Déchargement des données de la table `external_professionals`
--
...
--
-- Structure de la table `health_informations`
--
...
CREATE TABLE IF NOT EXISTS `health_informations` (
  ...
  PRIMARY KEY (`id`),
  KEY `link_category` (`category`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Tronquer la table avant d'insérer `health_informations`
--

TRUNCATE TABLE `health_informations`;
--
-- Déchargement des données de la table `health_informations`
--
...
(3, 'La santé de l\'enfant ', 'Une équipe de spécialistes vous accueille dans les centres de PMI et vous accompagne avant et après la naissance de votre enfant. Elle veille à favoriser son épanouissement et contribue au bien-être familial.\r\nDès les premiers jours et tout au long de la petite enfance, conseils et soutien vous sont proposés ainsi que des informations sur les besoins de votre enfant...', '452.jpg', 'https://www.sante.fr/la-sante-de-lenfant', 3),
...
(6, 'Hypertension artérielle', '\r\n\r\nLe médecin propose la réalisation d’un relevé d’automesure par le patient lui-même pour affirmer le diagnostic d’une hypertension artérielle afin de mettre en place un traitement adapté et efficace.\r\n...', 'hypertension.jpg', 'https://www.ameli.fr/allier/medecin/sante-prevention/pathologies/diagnostic-hta-automesure-tensionnelle', 6),
...
(9, 'Comprendre les addictions ', 'L’addiction est une pathologie qui repose sur la consommation répétée d’un produit (tabac, alcool, drogues…) ou la pratique anormalement excessive d’un comportement (jeux, temps sur les réseaux sociaux…) qui conduit à : une perte de contrôle du niveau de consommation/pratique,\r\nune modification de l’équilibre émotionnel....', 'addictions.jpg', 'https://www.sante.fr/addictions-du-plaisir-la-dependance', 1),
(10, 'Le suivi médical de la grossesse', 'Une grossesse, c’est tout à fait naturel. Ce n’est pas une maladie. Mais cela implique tout de même un suivi médical régulier.\r\n \r\nAu tout début, il n’est jamais facile de s’y retrouver, de savoir qui aller voir, quand, et pourquoi. On peut se sentir un peu perdue…', 'echo.jpg', 'https://www.sante.fr/le-suivi-medical-de-la-grossesse', 2),
...
(14, 'Maladie rénale chronique ', '\r\nLa maladie rénale chronique est une diminution du fonctionnement des reins qui ne filtrent plus correctement le sang. L\' hypertension artérielle et le diabète sont les causes les plus fréquentes. Le traitement ralentit la progression de l\'insuffisance rénale...', 'maladie-renale.jpg', 'https://www.ameli.fr/allier/assure/sante/themes/maladie-renale-chronique', 6),
(15, 'prévention2', 'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet', 'prevention.jpg', 'www.google.fr', 7),
...
CREATE TABLE IF NOT EXISTS `news` (
  ...
  `picture` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `external_link` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Tronquer la table avant d'insérer `news`
--
...
(1, 'Octobre Rose', 'Le cancer du sein est la tumeur maligne la plus fréquente chez la femme. Dans 95 % des cas, il s\'agit d\'un adénocarcinome. Certains facteurs de risque de cancer du sein sont connus...\r\n', 'octobre-rose.png', 'https://www.ameli.fr/assure/sante/themes/cancer-sein/comprendre-cancer-sein'),
...
--
-- Structure de la table `pharmacies_schedules`
--
...
--
-- Tronquer la table avant d'insérer `pharmacies_schedules`
--

TRUNCATE TABLE `pharmacies_schedules`;
--
-- Déchargement des données de la table `pharmacies_schedules`
--
...
CREATE TABLE IF NOT EXISTS `planning` (
  ...
  `pro_id` int NOT NULL,
  `day_id` int NOT NULL,
  `h_start_morning` time NOT NULL,
  `h_end_morning` time NOT NULL,
  `h_start_afternoon` time NOT NULL,
  `h_end_afternoon` time NOT NULL,
  PRIMARY KEY (`id`),
  KEY `link_day_id` (`day_id`),
  KEY `link_pro_id` (`pro_id`)
) ENGINE=InnoDB AUTO_INCREMENT=187 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Tronquer la table avant d'insérer `planning`
--
...
CREATE TABLE IF NOT EXISTS `professionals` (
  ...
  `zip` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `picture` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `LienSpe` (`speciality_id`)
) ENGINE=InnoDB AUTO_INCREMENT=116 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Tronquer la table avant d'insérer `professionals`
--
...
(17, 'Dr Regnier', 'Adeline', '4 rue du quatre septembre', '03150', 'Varennes-Sur-Allier', '0470497053', 'Suivi des enfants dès la naissance \r\nSuivi gynécologique', 10, 1, 'females-doctor-hospital-with-stethoscope-modified.png'),
...
(26, 'Laboratoire', 'Maymat', '4 Place du champ de mars ', '03150', 'Varennes-Sur-Allier', '0470457171', 'Médecins et Pharmaciens biologistes \r\nDocteur Véronique Siquier \r\nDocteur Sarah Raymond', 5, 1, 'females-doctor-hospital-with-stethoscope-modified.png'),
...
CREATE TABLE IF NOT EXISTS `specializations` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name_spe` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `picture` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `key_url` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Tronquer la table avant d'insérer `specializations`
--
...
--
-- Contraintes pour la table `health_informations`
--
...
--
-- Contraintes pour la table `pharmacies_schedules`
--
